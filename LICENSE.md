...
> Discord server statistics bot, member counts graphs 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

📊 &nbsp;**Member count** — live member count display channels

📈 &nbsp;**Growth** — daily join/leave graphs

👤 &nbsp;**Active members** — top chatters ranked

🔊 &nbsp;**Voice stats** — most active voice users

📅 &nbsp;**Custom range** — stats for any date period

📤 &nbsp;**Reports** — export charts as images
